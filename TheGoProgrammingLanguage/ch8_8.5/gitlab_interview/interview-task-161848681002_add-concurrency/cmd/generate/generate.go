...
const (
	// The README says to use -rootDir, but if a user decides not to... we should probably be defensive.
	// Currently this code fails if the defaultRootDir (non absolute) is used (no -rootDir value provided at command line).
	// How about just adding /tmp/dupe as the default?
	defaultRootDir    = "."
